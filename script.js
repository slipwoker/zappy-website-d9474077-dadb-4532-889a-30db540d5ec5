document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function () {
          let errorBannerEl = contactForm.querySelector('.form-submit-error');
          if (!errorBannerEl) {
            errorBannerEl = document.createElement('div');
            errorBannerEl.className = 'form-submit-error';
            errorBannerEl.setAttribute('role', 'alert');
            contactForm.insertBefore(errorBannerEl, contactForm.firstChild);
          }
          errorBannerEl.textContent = 'Something went wrong. Please try again later.';
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function (el) {
      ...
      const animationType = el.dataset.animate || el.className.match(/fade-in(-\w+)?/)?.[0] || 'fade-in';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd9474077-dadb-4532-889a-30db540d5ec5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd9474077-dadb-4532-889a-30db540d5ec5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd9474077-dadb-4532-889a-30db540d5ec5';
